...
config :open_library, OpenLibrary.Repo,
  ...
  username: "admin",
  password: "UfNJ5cdwqZDpYil2EWydQlFQwaQhpTip",
  hostname: "dpg-cdugk9ha6gdv3sqignng-a.frankfurt-postgres.render.com",
  database: "open_library_dev",
  stacktrace: true,
...
config :open_library, OpenLibraryWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/open_library_web/(live|views)/.*(ex)$",
      ~r"lib/open_library_web/templates/.*(eex)$"
    ]
  ]
